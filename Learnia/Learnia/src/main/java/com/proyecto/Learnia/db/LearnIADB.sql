...
VALUES
    ...
    ('¿Qué es la segunda ley de Newton y cómo se aplica?',
     'Estoy studying para un examen de física y no entiendo bien cómo usar F=ma con fricción.',
     NOW(), 3, 2),
    ('¿Cuál es la diferencia entre una lista y un arreglo en Java?',
     'En mi clase de programación usamos ArrayList y arreglos normales.',
     NOW(), 2, 3);